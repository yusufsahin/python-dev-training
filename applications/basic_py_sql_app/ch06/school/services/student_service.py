...
from school.repositories import DjangoStudentRepository, StudentRepository
...
class StudentService:
    ...
    def __init__(self, repository: StudentRepository | None = None) -> None:
        self._repo = repository or DjangoStudentRepository()
    ...
    def create_student(
        ...
        *,
        ...
        if not sn or not fn or not ln:
            raise ValidationError("Student number, first name and last name are required.")
        ...
        try:
            ...
            raise ValidationError("Could not create student (constraint violation).") from exc
    ...
    def update_student(
        ...
        *,
        ...
        try:
            ...
            raise ValidationError("Could not update student (constraint violation).") from exc
